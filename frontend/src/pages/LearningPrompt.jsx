...
const LearningPrompt = () => {
  ...
  // Redireciona se não tiver vindo do login
  if (!name || !apiKey) {
    ...
    >
      <div className="bg-white rounded-xl shadow-[0_8px_30px_rgba(0,0,0,0.3)] p-8 max-w-md w-full flex flex-col items-center">
        ...
        <textarea
          ...
          className="w-full border border-gray-300 rounded-md p-3 mt-4 resize-none focus:outline-none focus:ring-2 focus:ring-[#4a4a4a]"
        />

        <div className="mt-8 w-full max-w-[200px] flex justify-center">
          {loading ? (
